...
if args.direction is '1':
    upload(bearer, args.local_dir, args.mycloud_dir, args.progress_file, is_encrypted, args.encryption_pwd)
elif args.direction is '0':
    download(bearer, args.local_dir, args.mycloud_dir, args.progress_file, is_encrypted, args.encryption_pwd)